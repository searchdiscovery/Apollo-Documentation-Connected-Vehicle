...
|transaction.item[n].productInfo.package_id|string|Datasource for Package ID at the 'item-level'.||||||||
|transaction.item[n].productInfo.priceTier|string|Tracks the product Price Tier at the transaction \(order\) item level.||||||||
...
|transaction.item[n].productInfo.variant_id|string|Datasource for the Variant ID at the 'item-level'||||||||
